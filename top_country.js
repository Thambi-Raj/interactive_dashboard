var landkm_population=[
  ...
  function high_low(name){
          if(name=="lower"){
           ...
           document.querySelector('#root>#content>.section>#pop_den>#chart_container>.legend_area').remove();
          var verti = new Vertical_bar('#root>#content>.section>#pop_den>#chart_container', area_val);
  }
